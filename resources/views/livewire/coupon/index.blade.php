                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'is_public'])
                        </th>
                        <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('coupon_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('admin.coupons.show', $coupon) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('coupon_edit')
                                    ...
                                    @endcan
                                    @can('coupon_delete')
                                        <button class="btn btn-sm btn-rose mr-2" type="button" wire:click="confirm('delete', {{ $coupon->id }})" wire:loading.attr="disabled">
                                            {{ trans('global.delete') }}
                                        </button>
                                    @endcan
                                </div>
